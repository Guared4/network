...
Если перезагрузить сервера, то данные настроек выше просто не сохранятся, поэтому выполнил автоматизацию конфигурацию серверов с помощью скрипта **Ansible**
